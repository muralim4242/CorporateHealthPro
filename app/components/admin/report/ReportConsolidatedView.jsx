...
import {blue500,green500,orange500,red500} from 'material-ui/styles/colors';
    ...
    render() {
        return (
            <div>
                ...
                <Card>
                  <CardHeader>
                    <h2 className="text-center">{this.props.params["assName"] + " "}Report</h2>
                  </CardHeader>
                  <CardText>
                                    ...
                                    <table className="table table-bordered text-left">
                                        <thead>
                                            <tr>
                                                ...
                                                <td style={{backgroundColor:green500,padding:"5px" }}>
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style={{backgroundColor:orange500,padding:"5px" }}>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td style={{backgroundColor:red500,padding:"5px" }}>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div className="row text-center">
                                    <h2 style={{backgroundColor:blue500,padding:"5px" }}>HR/MD Says</h2>
                  ...
                  <CardActions>
                                <div className="row">
                                    <div className="col-md-2 ">
                                        <Link to={'/Admin/Report/1/1/View/ReportTypeCheck/Consolidated/Assessment/' + this.props.params["assName"] + '/List'} >
                                            <RaisedButton label="Back"/></Link>
                                    </div>
                                    <div className="col-md-4 col-md-offset-6">
                                        <div className="pull-right">
                                          ...
                                          <RaisedButton secondary={true} label="Delete"/>
                                            <div className="btn-group">
                                                  <RaisedButton  label="Download" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  <span className="caret"></span></RaisedButton>
